...
class WSI_Image_Vector_DB_Builder():
    def __init__(self):
        ...
        self.embed_cache_path = "Image2Image_Retrieval_pipeline/data/embeddings"
        self.database_path = "Image2Image_Retrieval_pipeline/data/vector_database"
